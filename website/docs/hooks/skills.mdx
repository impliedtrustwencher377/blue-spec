...
To actually run one of these against your code, import its file with a task, for example `@.bluespec/skills/regex.md`. See [**Available Skills**](../skills.mdx) for the full walkthrough.
:::

...
- Load the defense plan at `.bluespec/memory/plan.md`.
  - If it does not exist, initialize it from the template at `templates/plan-template.md` first, and identify every placeholder token of the form `[ALL_CAPS_IDENTIFIER]`.
